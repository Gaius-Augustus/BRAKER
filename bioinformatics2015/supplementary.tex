...
\begin{tabular}{lp{1.5cm}p{1.2cm}p{1.5cm}p{1.2cm}p{1.5cm}p{1.2cm}p{1.5cm}p{1.2cm}}\hline
 ...
 \hline
Gene sensitivity        & 52.6 & 64.4 & 42.8 & 55.0 & 54.6 & 67.6 & 81.3 & 77.2\\
Gene specificity        & 51.0 & 52.0 & 42.4 & 55.2 & 55.1 & 61.1 & 83.4 & 80.7\\
Transcript sensitivity  & 44.5 & 55.0 & 32.7 & 43.0 & 39.8 & 50.2 & 81.3 & 77.2\\
Transcript specificity  & 51.0 & 50.9 & 42.4 & 53.2 & 55.1 & 59.9 & 83.9 & 76.6\\
Exon sensitivity        & 80.5 & 82.9 & 79.7 & 80.2 & 66.6 & 73.3 & 87.4 & 82.7\\
Exon specificity        & 77.9 & 79.0 & 78.7 & 85.3 & 62.1 & 67.3 & 88.2 & 83.3\\
\hline
\end{tabular}
\end{sidewaystable}
...
\begin{sidewaystable}[h!]
\caption{\textit{Ab initio} prediction accuracy of SNAP, AUGUSTUS and GeneMark-ET (as trained for running MAKER2) on unmasked genomes. (Transcript specificity is not shown since it is in this case identical to Gene specificity; none of the methods is able to predict alternative transcripts in \textit{ab initio} mode.) \label{single_preds_maker}}
\begin{tabular}{lp{1.5cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}}\hline
 ...
 \hline
Gene sensitivity        & 14.5 & 37.5 & 32.6 & 21.0 & 23.9 & 21.5 & 40.8 & 41.3 & 33.4 & 50.3 & 61.8 & 63.4\\
Gene specificity        & 11.2 & 32.1 & 28.5 & 15.3 & 25.7 & 20.9 & 30.6 & 37.6 & 31.9 & 49.4 & 67.4 & 66.0\\
Transcript sensitivity  & 11.9 & 31.6 & 27.3 & 16.4 & 18.3 & 16.4 & 30.4 & 29.6 & 23.8 & 50.3 & 61.8 & 63.4\\
Exon sensitivity        & 58.7 & 71.5 & 69.9 & 67.9 & 69.1 & 69.7 & 57.4 & 56.3 & 53.3 & 66.4 & 64.8 & 67.5\\
Exon specificity        & 44.3 & 66.5 & 59.9 & 53.1 & 72.1 & 67.3 & 43.5 & 53.2 & 45.9 & 56.4 & 69.7 & 68.3\\
\hline
\end{tabular}
\end{sidewaystable}
...
\begin{sidewaystable}[h!]
\caption{\textit{Ab initio} prediction accuracy of AUGUSTUS trained by experts and fully automatically trained by BRAKER1 on softmasked genomes. (Transcript specificity is not shown since it is in this case identical to Gene specificity; AUGUSTUS is not able to predict alternative transcripts in \textit{ab initio} mode.) \label{single_preds_braker}}
\begin{tabular}{lp{1.5cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}}\hline
 ...
 \hline
Gene sensitivity        & 51.8 & 49.2 & 45.2 & 42.3 & 53.2 & 56.1 &  & 70.5 \\
Gene specificity        & 56.6 & 48.2 & 43.2 & 46.2 & 63.4 & 53.7 &  & 76.0  \\
Transcript sensitivity  & 44.2 & 41.6 & 35.2 & 32.7 & 39.0 & 41.1 &  & 70.4  \\
Exon sensitivity        & 79.8 & 76.4 & 76.1 & 74.9 & 67.7 & 65.0 &  & 73.2  \\
Exon specificity        & 81.7 & 79.8 & 81.5 & 83.4 & 67.4 & 63.3 &  & 83.1  \\
\hline
\end{tabular}
\end{sidewaystable}
