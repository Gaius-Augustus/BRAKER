...
Structural gene prediction is an important step in the analysis of sequenced genomes because downstream analysis depends on accurate prediction. One approach towards gene prediction is the usage of statistical models that have species-specific parameters. 
