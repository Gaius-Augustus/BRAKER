...
( time braker.pl --genome=../genome.fa --addUTR=on --softmasking --bam=../RNAseq.bam --workingdir=$wd --AUGUSTUS_hints_preds=../results/test3/augustus.hints.gtf --cores=8 --skipAllTraining --gff3 ) &> test3_add_utrs.log
